...
const findByEmail = async(email) => {
    const account = await getKnex()(tables.account)
        .where(`${tables.account}.email`, email).first(SELECT_COLUMNS);
    return formatAccount(account);
};


module.exports={ findAll, findById, create, updateById, deleteById, findByEmail };